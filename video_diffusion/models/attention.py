...
class SpatioTemporalTransformerBlock(nn.Module):
    ...
    def forward(
        ...
        # print("models/attention/test0")
        # print(type(self.attn1))video_diffusion.models.attention.SparseCausalAttention
        # from IPython import embed;embed()
        
        hidden_states = hidden_states + self.attn1(**kwargs) # 到这的函数都是不影响的也是想保留的
