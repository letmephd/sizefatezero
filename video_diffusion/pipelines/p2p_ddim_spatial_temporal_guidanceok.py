...
class P2pDDIMSpatioTemporalPipeline(SpatioTemporalStableDiffusionPipeline):
    ...
    def sd_ddim_pipeline(
        ...
        **args
        ...
        latents_tmp = F.interpolate(latents.view(-1,origin_lshape[-3],origin_lshape[-2],origin_lshape[-1]), (int(latents.shape[-2]*resize_scale), int(latents.shape[-1]*resize_scale))).view(origin_lshape)
